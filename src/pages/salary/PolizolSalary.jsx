...
//             <th>Sotuv (kg) </th>
//             {daysOfMonth.map((day) => (
//               <th key={`load-${day}`}>{productionMap[day]?.loadedKg || ""}</th>
//             ))}
//           </tr>
//           <tr>
//             <th>Sana</th>
...
function Salary({ data }) {
  ...
  const handlePrint = useReactToPrint({
    contentRef: tableRef, // content o'rniga contentRef ishlatildi
    documentTitle: `Polizol_Salary_${dayjs().format("YYYY_MM_DD")}`,
    pageStyle: `
      @page {
        size: A3;
        margin: 10mm;
  ...
  return (
    <div>
      ...
      <div ref={tableRef} className="salary-card">
        ...
        >
          <h3>Polizol-{dayjs().format("YYYY-MM")}</h3>
